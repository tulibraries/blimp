  ...
  class UploadsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create upload" do
      assert_difference('Upload.count') do
        post uploads_url, params: { upload: { datafile: @upload.datafile, id_field: @upload.id_field, map_filename: @upload.map_filename } }
      end
    ...
    test "should update upload" do
      patch upload_url(@upload), params: { upload: { datafile: @upload.datafile, id_field: @upload.id_field, map_filename: @upload.map_filename } }
